# Программа создает список из N элементов, заполненных числами из промежутка [-N, N], N вводит пользователь
...
print(new_list)
first_position = int(input('Введите первое натуральное число от 0 до %d :'%(number - 1)))
second_position = int(input('Введите второе натуральное число от 0 до %d не равное первому :'%(number - 1)))
